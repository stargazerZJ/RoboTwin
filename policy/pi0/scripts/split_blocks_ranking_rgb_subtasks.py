...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Input dataset root, e.g. policy/pi0/training_data/blocks_ranking_rgb/blocks_ranking_rgb-aloha-agilex_randomized_500-500",
    )
    parser.add_argument(
        "--out-root",
        type=str,
        required=True,
        help="Output dataset root, e.g. policy/pi0/training_data/blocks_ranking_rgb/blocks_ranking_rgb-aloha-agilex_randomized_split_500-500",
    )
    parser.add_argument(
        "--threshold",
        type=float,
