...
from policy.pi05.rubric_evaluation.server.webapp import create_app
...
def main() -> None:
    ...
    current_rubric_path = Path(f"policy/pi05/rubric_evaluation/rubrics/{cfg.task_name}_rubric.py")
